...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'Reception Agent', 'permission_name' => 'reception_agent_view'],
            ['application_name' => 'Reception Agent', 'permission_name' => 'reception_agent_update'],
            ['application_name' => 'Reception Agent', 'permission_name' => 'reception_agent_test'],
