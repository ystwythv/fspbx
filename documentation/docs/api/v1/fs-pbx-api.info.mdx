...
title: Voxra API Reference v1
sidebar_position: 1
---

The Voxra API is organized around REST. Our API has predictable resource-oriented URLs, returns JSON-encoded responses, and uses standard HTTP response codes, authentication, and verbs.

## Authentication
Use a **Bearer token** to authenticate requests. You can view and manage your API keys in **Voxra Dashboard -> Users**.
All API requests must be made over HTTPS. Calls made over plain HTTP will fail. API requests without authentication will also fail.

## Base path
Use your Voxra portal URL 

`https://YOUR-Voxra-HOST/`
...
## Errors
Voxra uses conventional HTTP response codes to indicate the success or failure of an API request. 
...
(e.g., a required parameter was omitted, a charge failed, etc.). Codes in the 5xx range indicate an error with Voxra server.
