# pfSense Port Forwarding for Voxra

# Voxra Behind Firewall (example: pfSense)
...
This guide walks you through configuring **port forwarding** on pfSense for a Voxra server.
...
- **Description:** e.g., `Forward SIP UDP 5060 to Voxra`
...
- Make sure your Voxra server firewall allows incoming connections on these ports.
